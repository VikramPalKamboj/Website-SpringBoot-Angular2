...
public class UserBilling implements Serializable {
	...
	private static final long serialVersionUID = -8771139575427936673L;
	
	@Id
	@GeneratedValue(strategy=GenerationType.AUTO)
	private Long id;
	private String userBillingNampe;
	...
	public String getUserBillingNampe() {
		return userBillingNampe;
	}

	public void setUserBillingNampe(String userBillingNampe) {
		this.userBillingNampe = userBillingNampe;
	}
