...
import OkkeSeller.Config.SecurityConfig;
...
import OkkeSeller.utility.MailConstructor;
...
public class UserResource {
	...
	public ResponseEntity forgetPasswordPost(
		...
		SimpleMailMessage emails = mailConstructor.constructNewUserEmail(user, password);
